...
static const char *fonts[]          = {	"Hack Nerd Font:size=10:antialias=true:hinting=true" };
static const char dmenufont[]       =   "Hack Nerd Font:size=10:antialias=true:hinting=true";

static const char col_gray1[]       = "#000000";	/* background color of bar */
static const char col_gray2[]       = "#444444";
static const char col_gray3[]       = "#bbbbbb";
static const char col_gray4[]       = "#eeeeee";
static const char col_cyan[]        = "#3c3c3c";	/* border color focused windows and tags */
...
static Key keys[] = {
	...
	{ MODKEY,							XK_period,					spawn,				SHCMD("/usr/bin/playerctl next") },
	{ MODKEY,							XK_comma,					spawn,				SHCMD("/usr/bin/playerctl previous") },
